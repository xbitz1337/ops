...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .su-zeile { display:flex; justify-content:space-between; align-items:center; padding:12px 0; border-bottom:1px solid rgba(45,106,173,0.1); }
  .su-name { font-weight:700; }
  .su-meta { font-family:var(--mono); font-size:11px; color:var(--text-dim); }
  .loeschen-btn { background:none; border:1px solid rgba(231,76,60,0.3); color:var(--red); font-family:var(--mono); font-size:9px; padding:5px 10px; cursor:pointer; }
</style>
</head>
<body>
