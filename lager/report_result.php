...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .report-summary { background:rgba(29,32,48,0.8); border:1px solid rgba(124,124,255,0.2); border-radius:16px; padding:18px 20px; margin-bottom:24px; text-align:left; }
  ...
  .action-btn {
    flex:1; padding:14px; font-family:var(--mono); font-size:12px; text-decoration:none; text-align:center; border:1px solid; border-radius:12px;
  }
