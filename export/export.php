...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .page-title { font-size:20px; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:#e8f4ff; margin-bottom:24px; }
  ...
  .btn-download { display:block; width:100%; text-align:center; background:none; border:1px solid var(--blue-bright); color:var(--blue-bright); padding:12px; font-family:var(--mono); font-size:12px; letter-spacing:1px; text-transform:uppercase; text-decoration:none; cursor:pointer; }
  .btn-download:hover { background:rgba(74,158,221,0.1); }
</style>
</head>
<body>
